namespace TcbInternetSolutions.Vulcan.Core
{
    internal class _TODOs
    {
        ...
        // TODONE: (WIP) need help in searching... Figure out how to index media file contents for things like pdf/doc(x) etc. (elastic needs mapper-attachments installed), seems to store base64 blob as well.
        // TODONE: Create simple search extension for site search queries that take search string and look for pages and files, with parameter to filter on search roots, and exclude certain types
        ...
        // TODONE: Add indexer to allow for custom objects that don't inherit IContent. And Search function in the vuclan client to handle.
